  ...
  colourGroups: { label: string; swatches: { token: string; name: string }[] }[] = [
    {
      ...
      swatches: [
        ...
        { token: '--colour-neutral-white-alpha-1', name: 'white-alpha-1' },
        { token: '--colour-neutral-white-alpha-2', name: 'white-alpha-2' },
        { token: '--colour-neutral-null', name: 'null' },
        { token: '--colour-neutral-darken-1', name: 'darken-1' },
      ],
    },
    {
      label: 'Brand — Purple',
      swatches: [
        ...
        { token: '--colour-brand-purple-darken', name: 'darken' },
      ],
    },
    {
      label: 'Brand — Red',
      swatches: [
        ...
        { token: '--colour-brand-red-darken', name: 'darken' },
      ],
    },
    {
      label: 'Brand — Yellow',
      swatches: [
        ...
        { token: '--colour-brand-yellow-darken', name: 'darken' },
      ],
    },
    {
      label: 'Brand — Green',
      swatches: [
        ...
        { token: '--colour-brand-green-darken', name: 'darken' },
      ],
    },
    {
      label: 'Dataviz — Coral',
      swatches: [
        { token: '--colour-dataviz-coral-default', name: 'default' },
        { token: '--colour-dataviz-coral-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-coral-focus', name: 'focus' },
        { token: '--colour-dataviz-coral-hint', name: 'hint' },
        { token: '--colour-dataviz-coral-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Lime',
      swatches: [
        { token: '--colour-dataviz-lime-default', name: 'default' },
        { token: '--colour-dataviz-lime-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-lime-focus', name: 'focus' },
        { token: '--colour-dataviz-lime-hint', name: 'hint' },
        { token: '--colour-dataviz-lime-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Parrot',
      swatches: [
        { token: '--colour-dataviz-parrot-default', name: 'default' },
        { token: '--colour-dataviz-parrot-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-parrot-focus', name: 'focus' },
        { token: '--colour-dataviz-parrot-hint', name: 'hint' },
        { token: '--colour-dataviz-parrot-translucent', name: 'translucent' },
        { token: '--colour-dataviz-parrot-strong', name: 'strong' },
      ],
    },
    {
      label: 'Dataviz — Turquoise',
      swatches: [
        { token: '--colour-dataviz-turquoise-default', name: 'default' },
        { token: '--colour-dataviz-turquoise-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-turquoise-focus', name: 'focus' },
        { token: '--colour-dataviz-turquoise-hint', name: 'hint' },
        { token: '--colour-dataviz-turquoise-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Sky',
      swatches: [
        { token: '--colour-dataviz-sky-default', name: 'default' },
        { token: '--colour-dataviz-sky-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-sky-focus', name: 'focus' },
        { token: '--colour-dataviz-sky-hint', name: 'hint' },
        { token: '--colour-dataviz-sky-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Ocean',
      swatches: [
        { token: '--colour-dataviz-ocean-default', name: 'default' },
        { token: '--colour-dataviz-ocean-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-ocean-focus', name: 'focus' },
        { token: '--colour-dataviz-ocean-hint', name: 'hint' },
        { token: '--colour-dataviz-ocean-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Lavender',
      swatches: [
        { token: '--colour-dataviz-lavender-default', name: 'default' },
        { token: '--colour-dataviz-lavender-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-lavender-focus', name: 'focus' },
        { token: '--colour-dataviz-lavender-hint', name: 'hint' },
        { token: '--colour-dataviz-lavender-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Rose',
      swatches: [
        { token: '--colour-dataviz-rose-default', name: 'default' },
        { token: '--colour-dataviz-rose-emphasis', name: 'emphasis' },
        { token: '--colour-dataviz-rose-focus', name: 'focus' },
        { token: '--colour-dataviz-rose-hint', name: 'hint' },
        { token: '--colour-dataviz-rose-translucent', name: 'translucent' },
      ],
    },
    {
      label: 'Dataviz — Legacy',
      swatches: [
        { token: '--colour-dataviz-legacy-bright-coral', name: 'bright-coral' },
        { token: '--colour-dataviz-legacy-bright-lime', name: 'bright-lime' },
        { token: '--colour-dataviz-legacy-bright-parrot', name: 'bright-parrot' },
        { token: '--colour-dataviz-legacy-bright-turquoise', name: 'bright-turquoise' },
        { token: '--colour-dataviz-legacy-bright-sky', name: 'bright-sky' },
        { token: '--colour-dataviz-legacy-bright-ocean', name: 'bright-ocean' },
        { token: '--colour-dataviz-legacy-bright-lavender', name: 'bright-lavender' },
        { token: '--colour-dataviz-legacy-bright-rose', name: 'bright-rose' },
      ],
    },
  ];
